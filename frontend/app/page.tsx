...
export default function HomePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#fbf9f8', color: '#1b1c1c' }}>
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <h1
              className="hero-title text-animated-shimmer"
              style={{
                fontSize: 38,
                fontWeight: 800,
                lineHeight: 1.22,
      ...
      <section className="content-section" style={{ padding: '64px 24px', width: '100%', background: '#fbf9f8' }}>
        <div
          style={{
            maxWidth: 1200,
            margin: '0 auto',
      ...
      <section className="content-section" style={{ padding: '56px 24px', width: '100%', background: '#fbf9f8' }}>
